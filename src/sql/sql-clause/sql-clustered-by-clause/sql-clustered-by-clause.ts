...
export class SqlClusteredByClause extends SqlClause {
  static type: SqlType = 'clusteredByClause';

  static DEFAULT_CLUSTERED_KEYWORD = 'CLUSTERED';
  ...
  protected _toRawString(): string {
    return [
      this.getKeyword('clustered', SqlClusteredByClause.DEFAULT_CLUSTERED_KEYWORD),
      this.getSpace('postClustered'),
      this.getKeyword('by', SqlClusteredByClause.DEFAULT_BY_KEYWORD),
